...
export const Navbar = ({ currentTab, onSelectTab }) => {
  const navItems = [
    ...
    { id: 'inventory', label: 'Inventory & Reorder Hub', icon: Boxes },
    { id: 'analytics', label: 'Time-Series & Model Diagnostics', icon: BarChart3 },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-bold text-base tracking-tight text-white">DemandIQ</span>
              ...
              <p className="text-xs text-slate-400">Demand Forecasting & Inventory Optimization</p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-800/80 border border-slate-700/60 text-xs">
            ...
            <span className="text-slate-300">LightGBM Engine:</span>
